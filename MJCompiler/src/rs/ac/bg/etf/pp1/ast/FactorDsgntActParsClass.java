...
public class FactorDsgntActParsClass extends Factor {

    private Designator Designator;
    private ActualPars ActualPars;

    public FactorDsgntActParsClass (Designator Designator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDsgntActParsClass(\n");
